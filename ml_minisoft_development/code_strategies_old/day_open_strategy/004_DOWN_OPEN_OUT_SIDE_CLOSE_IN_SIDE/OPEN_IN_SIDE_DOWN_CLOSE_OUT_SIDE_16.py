# win_trade_percentage = 71.43 & profit_trade_percentage = -86.1 (profit) & profit_loss_sum = -1533.900000000016 & count = 7 toatle = 9
import pandas as pd
...
for row_number_, row_record_ in df_bank_nifty_days_data.iloc[1:].iterrows():
    ...
    for row_number, row_record in df_bn_st_7_3.iloc[1:].iterrows():
        ...
        stop_loss = ((row_record.close - current_candle_dict_info['pre_close']) /
                     row_record.close)
        ...
        if row_number == 1:
            second_entry_condition_buy = row_record.high < current_candle_dict_info['cur_high']
        ...
        if primary_entry_condition_sell and diff_super_trend < 0.30:
            profit_loss_df = {'date_on_str': row_record.date_on_str,
                              ...
                              'target_value': current_candle_dict_info['pre_close'] - (0.10 * current_candle_dict_info['pre_close'] / 100),
